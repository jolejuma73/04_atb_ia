document.addEventListener("DOMContentLoaded", function() {
    // 1. Definición de datos de antibióticos
    const antibiotics = {
        // ... (datos de antibióticos sin cambios)
		A: [
    {
...
Z:[
{
    ...
    const botonVolver2 = document.getElementById("volver2");
    const contenedorBotonInicio = document.getElementById("main-button-container");
    ...
    for (let i = 65; i <= 90; i++) {
        ...
        listItem.addEventListener("click", () => {
            ...
            contenedorBotonInicio.style.display = "block";
        });
    ...
    antibioticItems.forEach((item) => {
        item.addEventListener("click", () => {
            const selectedAntibiotic = item.getAttribute("data-name"); // Obtener el nombre del atributo data-name
            displayDetails(selectedAntibiotic);
            contenedor1.style.display = "none";
            contenedor2.style.display = "none";
            contenedor3.style.display = "block";
            contenedorBotonInicio.style.display = "none";
            searchBar.value = "";
    ...
    if (!antibiotic) {
        console.error("No se encontró el antibiótico:", name);
        antibioticInfo.innerHTML = `<p style="color: red;">Detalles no disponibles.</p>`;
        return;
    }

    // ... (código para mostrar los detalles del antibiótico) ...
